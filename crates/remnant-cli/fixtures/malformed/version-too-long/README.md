...
Validates that Remnant rejects package `version` values longer than the current deterministic byte-length limit.

## Expected Result

- package metadata parsing: fail with `VersionIsTooLong`
