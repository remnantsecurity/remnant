...
pub(super) fn workspace_lockfile_fixture() -> Vec<u8> {
    std::fs::read(fixture_path("package-lock.v3.workspace.json"))
        .expect("workspace lockfile fixture should be readable")
}
